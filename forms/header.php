<?php
    ...
    //                                             <img src="assets/img/nmi_solutions/Solutions-Menu/menu-icon-1.png" width="45rem" height="45rem"/>
    //                                             <label class="font-sub-nav" data-bs-toggle="modal" data-bs-target="#rmm-endpoint-modal">Endpoint Management</label>
    //                                         </li>
    //                                         <li class="d-flex flex-column align-items-center gap-2 p-2">
    //                                             <img src="assets/img/nmi_solutions/Solutions-Menu/menu-icon-2.png" width="45rem" height="45rem"/>
    //                                             <label class="font-sub-nav" data-bs-toggle="modal" data-bs-target="#security-modal">Security</label>
    //                                         </li>
    //                                         <li class="d-flex flex-column align-items-center gap-2 p-2">
    //                                             <img src="assets/img/nmi_solutions/Solutions-Menu/menu-icon-3.png" width="50rem" height="50rem"/>
    //                                             <label class="font-sub-nav" data-bs-toggle="modal" data-bs-target="#backup-dr-modal">Backup & DR</label>
    //                                         </li>
    //                                     </div>
    //                                     <div class="col-4 border border-top-0 border-bottom-0">
    //                                         <li class="d-flex flex-column align-items-center gap-2 p-2">
    //                                             <img src="assets/img/nmi_solutions/Solutions-Menu/menu-icon-4.png" width="50rem" height="50rem"/>
    //                                             <label class="font-sub-nav" data-bs-toggle="modal" data-bs-target="#audit-modal">Audit</label>
    //                                         </li>
    //                                         <li class="d-flex flex-column align-items-center gap-2 p-2">
    //                                             <img src="assets/img/nmi_solutions/Solutions-Menu/menu-icon-5.png" width="50rem" height="50rem"/>
    //                                             <label class="font-sub-nav" data-bs-toggle="modal" data-bs-target="#compliance-modal">Compliance</label>
    //                                         </li>
    //                                     </div>
    //                                     <div class="col-4">
    //                                         <li class="d-flex flex-column align-items-center gap-2 p-2">
    //                                             <img src="assets/img/nmi_solutions/Solutions-Menu/menu-icon-6.png" width="50rem" height="50rem"/>
    //                                             <label class="font-sub-nav" data-bs-toggle="modal" data-bs-target="#servicedesk-modal">Service Desk</label>
    //                                         </li>
    //                                         <li class="d-flex flex-column align-items-center gap-2 p-2">
    //                                             <img src="assets/img/nmi_solutions/Solutions-Menu/menu-icon-7.png" width="50rem" height="50rem"/>
    ...
    <div class="modal" id="smallNavModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content sm-nav-collapse">
                ...
                <ul class="container d-flex flex-column gap-4 py-2">
                            ...
                            <div class="container text-center">
                                <div class="row row-cols-2">
                                    <div class="d-flex flex-column align-items-center gap-2 p-2" id="mobileTab">
                                        <img src="assets/img/nmi_solutions/Solutions-Menu/menu-icon-1.png" width="50rem" height="50rem"/>
                                        <label class="font-sub-nav" data-bs-toggle="modal" data-bs-target="#rmm-endpoint-modal">Endpoint Management</label>
                                    </div>
                                    <div class="d-flex flex-column align-items-center gap-2 p-2" id="mobileTab">
                                        <img src="assets/img/nmi_solutions/Solutions-Menu/menu-icon-2.png" width="50rem" height="50rem"/>
                                        <label class="font-sub-nav" data-bs-toggle="modal" data-bs-target="#security-modal">Security</label>
                                    </div>
                                    <div class="d-flex flex-column align-items-center gap-2 p-2" id="mobileTab">
                                        <img src="assets/img/nmi_solutions/Solutions-Menu/menu-icon-3.png" width="50rem" height="50rem"/>
