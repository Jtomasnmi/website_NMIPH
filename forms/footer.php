    ...
    <div class="footer-top">
        ...
        <hr class="mb-5">
            <div class="footer-grid">
                <div class="footer-contact">
                    <!-- <h3>Presento<span>.</span></h3> -->
                    <img src="assets/img/logo/NMILogo2025Colored.png" class="ratio ratio-1x1 w-50"></img>
                ...
                <div class="social-links">
                    <div class="d-flex flex-column gap-1">
                        ...
                        <a class="text-blue-1 text-xs">Kaseya 365 Endpoint</a>
                        <a class="text-blue-1 text-xs">Kaseya 365 User</a>
                    ...
                    <div class="d-flex flex-column gap-1">
                        ...
                        <a class="text-blue-1 text-xs" data-bs-toggle="modal" data-bs-target="#audit-modal">Audit</a>
                        <a class="text-blue-1 text-xs" data-bs-toggle="modal" data-bs-target="#compliance-modal">Compliance</a>
                        <a class="text-blue-1 text-xs" data-bs-toggle="modal" data-bs-target="#servicedesk-modal">Service Desk</a>
                        <a class="text-blue-1 text-xs" data-bs-toggle="modal" data-bs-target="#it-documentation-modal">IT Documentation</a>
                    </div>
                </div>
            </div>
            <hr class="mb-5">
